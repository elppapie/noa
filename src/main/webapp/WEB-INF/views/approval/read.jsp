...
<script>
	...
	$(document).on('click', '#btnSave', function(e){//결재(저장)
	...
	$(document).on('click', '#btnList', function(e){//반려

		e.preventDefault();


		location.href="${pageContext.request.contextPath}/approval/#";//반려 스티커 붙은 페이지로 이동
	...
	<article>
		...
		<div class="container" role="main">
			...
			<div >
				...
				<button type="button" class="btn btn-sm btn-primary" id="btnSave">결재</button>

				<button type="button" class="btn btn-sm btn-primary" id="btnList">반려</button>
