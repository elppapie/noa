		...
		<div class="card cards-rounded">
			<div class="card-body">
				<div class="d-sm-flex justify-content-between align-items-start">
					<div>
						<h4 class="card-title card-title-dash">휴 지 통</h4>
				...
				<div class="table-responsive  mt-1">
					<table class="table select-table">
						...
						<tbody>
							<c:if test="${empty recyclemail}" var="isEmpty">
								<tr>
									<td colspan="6">수신한 메일이 없습니다.</td>
								</tr>
							</c:if>
							<c:if test="${not isEmpty recyclemail}">
								<c:forEach var="mail" items="${recyclemail}" varStatus="loop">
