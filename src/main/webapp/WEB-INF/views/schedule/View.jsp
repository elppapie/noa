	...
	<div class="tab-pane fade show active scroll-wrapper" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
		...
		<form class="needs-validated" action="<c:url value='/Schedule/editOk.kosmo'/>" method='POST'>
			...
			<div class="form-group input-group">
				...
				<input type="text" class="form-control" value="${fn:split(one['SCHE_ENDDATE'],' ')[1]}" name="sche_enddate_t" id="sche_enddate_t">
				<div class="valid-feedback">Valid.</div>
    			<div class="invalid-feedback">Please fill out this field.</div>	    						
			</div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" value="${one['SCHE_COLOR']}" name="sche_color" id="sche_color">
				<div class="valid-feedback">Valid.</div>
    			<div class="invalid-feedback">Please fill out this field.</div>
			</div>
